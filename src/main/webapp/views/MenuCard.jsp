		...
		<div class="collapse navbar-collapse" id="navbarSupportedContent">
			<ul class="navbar-nav mr-auto">
				<li class="nav-item active"><a class="nav-link"
					href="MenuCard.jsp">Menu Card <span class="sr-only">(current)</span>
				</a></li>
	...
	<div class="container menuContainer">
	 	<div class="row">
			<div class="col-sm-12 col-md-6">
				<a href="../projectimg/card1.jpg" target="_blank"> <img
					alt="Menu Card" src="../projectimg/card1.jpg"></a>
			</div>
			<div class="col-sm-12 col-md-6">
				<a href="../projectimg/card1.jpg" target="_blank"><img
					alt="Menu Card" src="../projectimg/card2.jpg"></a>
			</div>
		</div>
